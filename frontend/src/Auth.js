      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <div className="password-container">
          <input
            ...
            required
            style={{ padding: '10px', fontSize: '1rem', fontFamily: 'Orbitron, sans-serif', borderRadius: '5px', border: '1px solid #49dafd', backgroundColor: 'rgba(0,0,0,0.3)', color: 'white', width: '100%', boxSizing: 'border-box' }}
          />
          <span
