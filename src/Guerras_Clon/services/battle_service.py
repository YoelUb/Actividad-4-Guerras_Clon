...
from ..api.models.star_wars_models import Personaje
...
class AtaqueNormal(Habilidad):
    ...
    def ejecutar(self, atacante: Personaje, defensor: Personaje) -> (int, str):
        ...
        daño = max(1, atacante.info.daño - (defensor.info.defensa // 10))
        return daño, f"{atacante.nombre} ataca a {defensor.nombre} y causa {daño} de daño."
...
class AtaqueEspecial(Habilidad):
    ...
    def ejecutar(self, atacante: Personaje, defensor: Personaje) -> (int, str):
        ...
        daño = max(1, atacante.info.ataque_especial - (defensor.info.defensa // 10))
        return daño, f"{atacante.nombre} usa su habilidad especial contra {defensor.nombre} y causa {daño} de daño."
